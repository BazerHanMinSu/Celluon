...
QT_MOC_LITERAL(1, 13, 15), // "SigClickTrigger"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5) // "index"

    },
    "QImageWidget\0SigClickTrigger\0\0index"
};
...
void QImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SigClickTrigger((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (QImageWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QImageWidget::SigClickTrigger)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void QImageWidget::SigClickTrigger(int _t1)
{
